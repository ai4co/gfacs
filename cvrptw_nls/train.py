...
def generate_traindata(count, n_node, k_sparse):
    for _ in range(count):
        instance = demands, distance, _, windows = gen_instance(n_node, DEVICE, TAM)
...
def train(
        ...
        val_interval=5,
        pretrained=None,
        savepath="../pretrained/cvrptw_nls",
        run_name="",
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", type=str, default="../pretrained/cvrptw_nls",
